...
import { ButtonProps } from '../../types/admin';
...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: 'bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white shadow-lg hover:shadow-xl focus:ring-amber-500',
